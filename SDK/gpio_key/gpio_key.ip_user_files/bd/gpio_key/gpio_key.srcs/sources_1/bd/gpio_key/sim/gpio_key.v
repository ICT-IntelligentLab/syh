...
//Date        : Tue Nov 25 19:47:08 2025
//Host        : hanbao running 64-bit major release  (build 9200)
//Command     : generate_target gpio_key.bd
//Design      : gpio_key
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "gpio_key,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=gpio_key,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "gpio_key.hwdef" *) 
module gpio_key
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  gpio_key_processing_system7_0_0 processing_system7_0
