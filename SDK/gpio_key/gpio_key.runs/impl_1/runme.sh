...
HD_PWD='D:/ZynqProject/SDK/gpio_key/gpio_key.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_key_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_key_wrapper.tcl -notrace
