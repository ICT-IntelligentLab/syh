...
HD_PWD='D:/ZynqProject/SDK/gpio_key/gpio_key.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_key_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_key_wrapper.tcl
