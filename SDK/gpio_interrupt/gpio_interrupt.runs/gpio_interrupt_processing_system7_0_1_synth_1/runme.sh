...
HD_PWD='D:/ZynqProject/SDK/gpio_interrupt/gpio_interrupt.runs/gpio_interrupt_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_interrupt_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_interrupt_processing_system7_0_1.tcl
