...
HD_PWD='D:/ZynqProject/ip_ram/ip_ram.runs/ram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_1.tcl
