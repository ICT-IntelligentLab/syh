...
HD_PWD='D:/ZynqProject/uart_loopback_top/uart_loopback_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_lookback_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_lookback_top.tcl -notrace
