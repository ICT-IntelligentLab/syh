...
HD_PWD='D:/ZynqProject/uart_loopback_top/uart_loopback_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_lookback_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_lookback_top.tcl
