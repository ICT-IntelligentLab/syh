...
#
# Generated by export_simulation on Tue Nov 25 19:47:08 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './gpio_key.sh' script.

./gpio_key.sh -reset_run
...
./gpio_key.sh -noclean_files

For more information on the script, please type './gpio_key.sh -help'.
